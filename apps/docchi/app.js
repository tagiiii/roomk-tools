...
const TOPICS = [
  ...
  { cat: 'asobi', q: '公園であそぶなら？', a: 'ブランコ', b: 'すべりだい', ask: 'ブランコどこまで高くこげる？' },
  { cat: 'asobi', q: 'ボードゲームなら？', a: '人生ゲーム', b: 'オセロ', ask: 'つよい自信ある？' },
  ...
  { cat: 'seikatsu', q: '乗りものの席なら？', a: 'まど側', b: '通ろ側', ask: 'まどから何を見るのがすき？' },
