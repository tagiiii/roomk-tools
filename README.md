...
本ツール群は、たぎ個人が独立して制作・公開しています。room-Kの公式制作物ではなく、同サービスの運営主体による提供・監修・公認を示すものではありません。
...
本ツール群には、[独自の利用条件](./LICENSE.md)を適用します。

- 支援活動での利用・必要な改変を認めます。有料の支援活動の中で道具として使うこともできます。
- コピーや改変版の無料での再配布・公開を認めます。「たぎ」の原作者表記・著作権表示・利用条件を残し、改変版では変更者と主な変更内容を明記してください。同じ利用条件を引き継ぎ、公式・公認と誤解させる表示はしないでください。
- 原版・改変版の販売や、ツール自体の有料提供には、たぎの事前の個別許可が必要です。
- 第三者のライブラリ・フォント・素材等には、それぞれのライセンス・利用条件が適用されます。
